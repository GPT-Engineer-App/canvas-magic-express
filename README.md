...
**Project**: canvas-magic-express 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: create a full screen excalidraw canvas 
...
```sh
git clone https://github.com/GPT-Engineer-App/canvas-magic-express.git
cd canvas-magic-express
npm i
